...
cfg_test = HoneycombConfig(
    reinforcement_root_radius=0.0,
    reinforcement_tip_radius=0.0,
...
print(f"Step 2: Extruded cell solid type={cell_solid.ShapeType}, isValid={cell_solid.isValid()}, faces={len(cell_solid.Faces)}, edges={len(cell_solid.Edges)}")
...
print(f"Step 3: Fused male joints solid type={cell_solid.ShapeType}, isValid={cell_solid.isValid()}, faces={len(cell_solid.Faces)}, edges={len(cell_solid.Edges)}")
...
print(f"Step 4: Cut female grooves solid type={cell_solid.ShapeType}, isValid={cell_solid.isValid()}, faces={len(cell_solid.Faces)}, edges={len(cell_solid.Edges)}")
