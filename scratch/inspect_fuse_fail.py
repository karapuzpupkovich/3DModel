...
# Create male joint 1 face (face_index 5)
alpha_deg, _ = get_face_angle_and_dist(5, cfg)
face_mid = (vertices_out[5] + vertices_out[0]) * 0.5
...
# Let's check common area
common = outer_face.common(mf)
print(f"Intersection Area: {common.Area:.6f} mm^2")

# Let's save shapes to a file for manual inspection
doc = FreeCAD.newDocument("TestFuseFail")
o = doc.addObject("Part::Feature", "OuterFace")
o.Shape = outer_face
m = doc.addObject("Part::Feature", "MaleFace5")
m.Shape = mf
doc.saveAs(r"c:\3DModel\scratch\TestFuseFail.FCStd")
print("Saved debug doc to c:\\3DModel\\scratch\\TestFuseFail.FCStd")
