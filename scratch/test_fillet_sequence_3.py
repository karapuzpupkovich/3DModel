...
print("Starting test_fillet_sequence_3...")
...
for face_index in (0, 5):
    ...
    start_box.rotate(FreeCAD.Vector(0, 2.2, 0.0), FreeCAD.Vector(1, 0, 0), 45.0) # corrected rotation center and angle!
...
print("Fused male joints successfully. Solid isValid:", cell_solid.isValid())
