...
/* [Текст] */
letters  = ["М", "А", "Т", "В", "Е", "Й"];   // буквы по отдельности
x_pos    = [-31.713, -17.013, -7.549, 1.201, 9.8414, 19.263];      // X-позиция каждой буквы, мм (уже с учётом spacing)
groups   = [[10.25, [1, 3, 5]], [11.4, [0, 2, 4]]];    // [[высота, [индексы букв этой высоты]], ...]
...
bridges  = [[5, 2.8875, 10.9278, 4.3875, 14.6079], [5, 7.875, 10.9333, 9.9667, 15.2537]];
