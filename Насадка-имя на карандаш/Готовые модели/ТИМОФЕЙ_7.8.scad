...
/* [Текст] */
letters  = ["Т", "И", "М", "О", "Ф", "Е", "Й"];   // буквы по отдельности
x_pos    = [-39.2605, -30.5105, -20.1225, -5.4225, 5.0215, 18.0556, 27.4772];      // X-позиция каждой буквы, мм (уже с учётом spacing)
groups   = [[10.25, [1, 3, 5]], [11.4, [0, 2, 4, 6]]];    // [[высота, [индексы букв этой высоты]], ...]
y_off    = -5.8583;      // сдвиг по Y: центрирует текст на оси отверстия
...
bridges  = [[6, 2.8875, 10.9278, 4.3875, 14.6079], [6, 7.875, 10.9333, 9.9667, 15.2537]];
