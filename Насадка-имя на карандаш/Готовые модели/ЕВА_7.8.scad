...
/* [Текст] */
letters  = ["Е", "В", "А"];   // буквы по отдельности
x_pos    = [-15.8103, -6.3323, 2.477];      // X-позиция каждой буквы, мм (уже с учётом spacing)
groups   = [[11.75, [1]], [12.9, [0, 2]]];    // [[высота, [индексы букв этой высоты]], ...]
