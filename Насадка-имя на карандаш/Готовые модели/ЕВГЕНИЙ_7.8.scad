...
x_pos    = [-34.2285, -24.7505, -15.8885, -7.6285, 1.5449, 11.4238, 21.8118];      // X-позиция каждой буквы, мм (уже с учётом spacing)
groups   = [[10.25, [1, 3, 5]], [11.4, [0, 2, 4, 6]]];    // [[высота, [индексы букв этой высоты]], ...]
y_off    = -5.85;      // сдвиг по Y: центрирует текст на оси отверстия
