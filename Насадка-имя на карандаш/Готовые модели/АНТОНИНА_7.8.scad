...
/* [Текст] */
letters  = ["А", "Н", "Т", "О", "Н", "И", "Н", "А"];   // буквы по отдельности
x_pos    = [-40.4842, -29.5642, -19.5541, -13.075, -2.631, 7.248, 17.5741, 27.5842];      // X-позиция каждой буквы, мм (уже с учётом spacing)
groups   = [[11.75, [1, 3, 5, 7]], [12.9, [0, 2, 4, 6]]];    // [[высота, [индексы букв этой высоты]], ...]
