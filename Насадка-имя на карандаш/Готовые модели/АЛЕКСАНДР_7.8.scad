...
/* [Текст] */
letters  = ["А", "Л", "Е", "К", "С", "А", "Н", "Д", "Р"];   // буквы по отдельности
x_pos    = [-45.3543, -34.4343, -24.9435, -15.5219, -5.8637, 2.2543, 13.1743, 23.1843, 34.8043];      // X-позиция каждой буквы, мм (уже с учётом spacing)
