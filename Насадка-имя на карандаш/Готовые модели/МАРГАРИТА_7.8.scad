...
/* [Текст] */
letters  = ["М", "А", "Р", "Г", "А", "Р", "И", "Т", "А"];   // буквы по отдельности
x_pos    = [-46.1431, -31.4431, -20.5231, -11.6527, -4.5432, 6.3768, 15.0759, 25.4639, 32.7764];      // X-позиция каждой буквы, мм (уже с учётом spacing)
groups   = [[11.75, [1, 3, 5, 7]], [12.9, [0, 2, 4, 6, 8]]];    // [[высота, [индексы букв этой высоты]], ...]
y_off    = -5.8333;      // сдвиг по Y: центрирует текст на оси отверстия
