...
groups   = [[11.75, [1, 3]], [12.9, [0, 2, 4]]];    // [[высота, [индексы букв этой высоты]], ...]
y_off    = -5.25;      // сдвиг по Y: центрирует текст на оси отверстия
