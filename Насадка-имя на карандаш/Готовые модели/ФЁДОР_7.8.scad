...
/* [Текст] */
letters  = ["Ф", "Ё", "Д", "О", "Р"];   // буквы по отдельности
x_pos    = [-27.5618, -14.5278, -5.0498, 6.5011, 16.9451];      // X-позиция каждой буквы, мм (уже с учётом spacing)
groups   = [[10.25, [1, 3]], [11.4, [0, 2, 4]]];    // [[высота, [индексы букв этой высоты]], ...]
...
bridges  = [[1, 7.3083, 10.8667, 9.8083, 13.1544], [1, 3.0333, 10.6898, 5.5333, 13.1945]];
