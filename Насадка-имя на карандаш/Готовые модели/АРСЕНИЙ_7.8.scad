...
/* [Текст] */
letters  = ["А", "Р", "С", "Е", "Н", "И", "Й"];   // буквы по отдельности
x_pos    = [-34.8057, -23.8857, -14.9512, -6.6179, 2.5554, 12.4344, 22.8224];      // X-позиция каждой буквы, мм (уже с учётом spacing)
groups   = [[10.25, [1, 3, 5]], [11.4, [0, 2, 4, 6]]];    // [[высота, [индексы букв этой высоты]], ...]
y_off    = -5.8417;      // сдвиг по Y: центрирует текст на оси отверстия
