...
/* [Текст] */
letters  = ["У", "Л", "Ь", "Я", "Н", "А"];   // буквы по отдельности
x_pos    = [-29.7219, -21.5139, -11.6397, -2.4696, 6.3619, 16.3719];      // X-позиция каждой буквы, мм (уже с учётом spacing)
groups   = [[11.75, [1, 3, 5]], [12.9, [0, 2, 4]]];    // [[высота, [индексы букв этой высоты]], ...]
y_off    = -5.8;      // сдвиг по Y: центрирует текст на оси отверстия
