...
class HoneycombConfig:
    ...
    perforation_cols_face_0: tuple[float, ...] = (-21.0, -14.0, -7.0, 0.0, 7.0, 14.0, 21.0)
    # Face 1 (Top side - Female joint):
    perforation_cols_face_1: tuple[float, ...] = (-28.0, -21.0, -14.0, -7.0, 0.0, 7.0, 14.0, 21.0, 28.0)
    # Face 2 (Left side - Female joint):
    perforation_cols_face_2: tuple[float, ...] = (-21.0, -14.0, -7.0, 0.0, 7.0, 14.0, 21.0)
    # Face 3 (Bottom side - Male joint):
    perforation_cols_face_3: tuple[float, ...] = (-28.0, -21.0, -14.0, -7.0, 0.0, 7.0, 14.0, 21.0, 28.0)
