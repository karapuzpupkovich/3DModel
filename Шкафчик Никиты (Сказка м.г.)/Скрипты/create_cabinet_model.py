...
def create_Стандартная_ячейка_shape():
    ...
    for i in [0, 5]:
        ...
        male_face_local = make_centered_trapezoid_face(FreeCAD.Vector(0,0,0), 90.0, -0.5, 3.0, 30.0, 38.0, 0.0, 0.4)
        ...
        box_start.translate(FreeCAD.Vector(0, 0, 2.0))
        ...
        box_end.translate(FreeCAD.Vector(0, 0, 198.0))
...
# Сохраняем проект
save_dir = r"C:\3DModel\Шкафчик Никиты (Сказка м.г.)\Готовые модели"
